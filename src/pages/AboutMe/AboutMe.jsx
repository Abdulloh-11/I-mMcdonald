...
import './AboutMe.scss';
import mee1 from './images/me1.jpg'
  ...
  return (
    <section className='AboutMe'>
        ...
        <article className='container'>
            <p>I am G'ulomov Abdulloh, a 20-year-old Web Developer from Tashkent, Uzbekistan.</p>
            ...
            <img src={mee3} alt="me" />
            <p>In short, it's me G'ulomov Abdulloh, , a friendly programmer from Uzbekistan. You can read my story of becoming a software engineer <a className='text-blue-400' target="blank" href="https://www.instagram.com/uzakoff_u/">here</a>.</p>
        </article>
    </section>
  )
}
